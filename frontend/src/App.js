	...
	render() {
		return (
			<main className="d-flex justify-content-center my-4">
				<div className="bg-purple-900 text-white">My Books App</div>
				<div  className="col-5">
					<ToggleableBookForm 
...
class ToggleableBookForm extends React.Component {
	...
	render() {
		if (this.state.inCreateMode) {
			return (
				<div className="mb-2 p-3" style={{boxShadow: '0 0 5px #fff'}} >
					<BookForm
		...
		return (
			<button onClick={this.handleCreateClick} className="btn btn-success inline-flex">
				<FaPlusCircle></FaPlusCircle>New
		...
		return (
			<div className="card">
				<div className="card-header d-flex justify-content-between">
					...
					<div>
						<FaEdit onClick={this.props.onEditClick} className="mr-2 mb-2"></FaEdit>
						<FaTrash onClick={this.props.onDeleteClick}></FaTrash>
					</div>
